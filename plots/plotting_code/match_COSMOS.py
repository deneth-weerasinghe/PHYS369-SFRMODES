...
def match_COSMOS(i):
    myrows = []
    with open(path + '/data/csv/group_COSMOS.csv', newline='') as f1, open(path + f'/data/csv/COSMOS_survey/COSMOS_{i}.csv') as f2:
        ...
        for group_row in group_data:
            for cosmos_row in cosmos_data:
                ...
                ra_diff = abs(float(group_row[1])-float(cosmos_row[0]))#abs(150.67986638-150.679866)
                ra_tol = tol*max(float(group_row[1]), float(cosmos_row[0]))#tol*max(150.67986638, 150.679866)
                dec_diff = abs(float(group_row[2])-float(cosmos_row[1]))#abs(2.1966146-2.196563)
                dec_tol = tol*max(float(group_row[2]), float(cosmos_row[1]))#tol*max(2.1966146, 2.196563)
